...
public class RelatorioEsporteForm extends JPanel {
    ...
    public void iniciarVetorComponentes(Vector<Esporte> vetorDados){
        tabela = new TableEsporte(nomeColunas, vetorDados);
        table = new  JTable();
    ...
    public static void emitirRelatorio(List<Esporte> esportes){
        try {
            ...
            Vector<Esporte>vetorDados = new Vector<Esporte>();
            for (Esporte esporte1: esportes ) {
